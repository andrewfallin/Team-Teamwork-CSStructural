...
public class HalsteadChecks extends AbstractCheck {
  ...
  public void finishTree(DetailAST ast) {
    ...
    log(ast, "halsteadvocab", halsteadVocabulary);
    log(ast, "halsteadlength", halsteadLength);
    log(ast, "uniqueoperandcount", uniqueOperandCount);
    log(ast, "uniqueoperatorcount", uniqueOperatorCount);
    log(ast, "operandcount", operandCount);
    log(ast, "operatorcount", operatorCount);
