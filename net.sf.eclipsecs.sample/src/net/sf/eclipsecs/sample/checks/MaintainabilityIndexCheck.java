...
public class MaintainabilityIndexCheck extends HalsteadChecks {
  ...
  public void finishTree(DetailAST ast) {
    ...
    percentComments = count * 100 / LOC;

    MI = (int) (171 - 5.2 * Math.log(halsteadVolume) - .23 * cyclo - 15.2 * Math.log(LOC) + 50 * Math.sin(Math.sqrt(2.4 * percentComments)));
    
    log(ast, "maintainabilityindex", MI);
